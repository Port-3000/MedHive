      ...
      <nav className="w-full bg-white shadow-md dark:bg-gray-900">
        <div className="container mx-auto px-6 py-3 flex justify-between items-center">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-primary-600">MedHive</span>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              MedHive uses Groq&apos;s ultra-fast inference to deliver real-time health insights while protecting patient data through secure federated learning.
            </p>
